...
public class UniversityServiceImpl implements UniversityService {
    ...
    @Override
    public void chooseUniversity(Applicant applicant, KeyPair applicantKeyPair, University university, KeyPair universityKeyPair, Observer observer) {
    ...
    @Override
    public void chooseSpeciality(Applicant applicant, Speciality speciality, KeyPair applicantKeyPair, University university, KeyPair universityKeyPair, Observer observer) {
