...
public interface UniversityService {
    ...
    void chooseUniversity(Applicant applicant, KeyPair applicantKeyPair, University university, KeyPair universityKeyPair, Observer observer);

    void chooseSpeciality(Applicant applicant, Speciality speciality, KeyPair applicantKeyPair, University university, KeyPair universityKeyPair, Observer observer);
